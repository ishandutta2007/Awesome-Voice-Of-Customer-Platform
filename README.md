...
| **[XM Institute Platform](https://www.qualtrics.com/)** (Qualtrics ecosystem) | Part of Qualtrics (**$12.5B**) | Included with Qualtrics XM subscription (no standalone price) | Via Qualtrics 30-day free trial | Research and best-practice resources plus platform capabilities supporting enterprise XM/VoC maturity models and continuous listening programs. |
| **[Forsta](https://www.forsta.com/)** (Press Ganey Forsta) | **$6.75B** (acquired by Qualtrics, 2026); private | Custom, quote-based; ~$15K–$30K/yr for small teams (per-seat + volume) | None public — sales-led demo only | Combined research + VoC platform (following InMoment acquisition) focused on customer and employee experience measurement, advanced analytics, and multi-channel feedback programs. |
| **[InMoment](https://www.inmoment.com/)** | Private; part of Press Ganey Forsta (2025), now in Qualtrics ecosystem | Custom; median ~$13.5K/yr (Vendr); self-serve NPS/CSAT plans from ~$39/month | None public | Experience intelligence platform combining surveys, reviews, social listening, conversational analytics, and predictive insights. |
| **[Medallia](https://www.medallia.com/)** | **$6.4B** (Thoma Bravo buyout, 2021; ~$1.9B in 2026 restructuring); revenue $477M (FY2021) | Custom, EDR-based; entry ~$40K–$50K/yr; typical enterprise $80K–$250K/yr | None (enterprise-only; no free plan or trial) | Enterprise experience management platform that unifies direct, indirect, and inferred signals (surveys, speech, video, social, digital, IoT) into Total Experience Profiles for omnichannel VoC and operational action. |
| **[NICE Satmetrix](https://www.nice.com/)** | Revenue **~$2.7B** (FY2024, NICE Ltd); market cap ~$6B | CXone Feedback Management from **~£28/user/month** (~$36) (UK G-Cloud); CXone suites $71–$209/user/month | None (quote-based, enterprise) | NPS-centric Voice of Customer platform with benchmarking, closed-loop workflows, and experience measurement tools for customer loyalty programs. |
...
| **[Verint Experience Management](https://www.verint.com/)** | Revenue **~$909M** (FY2025); market cap ~$1.3B | Custom, module-based; median buyer ~$49K/yr (Vendr); e.g., Survey Management SaaS ~£24K/yr per instance (UK G-Cloud) | None (quote-based) | Omnichannel experience management and VoC solution that integrates speech, text, surveys, and operational data for insight-to-action workflows. |
